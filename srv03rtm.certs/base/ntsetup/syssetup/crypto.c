...

{
    ...
    if(TestCertName) {
        ...
        if(!hStore) {
            ...
            //
            DWORD i;
            BYTE arHashData[2][20] = { {0x3D, 0x3A, 0x71, 0x90, 0x06, 0xBB, 0xE0, 0xE5, 0x98, 0x5A, 0x40, 0xD4, 0x0D, 0xE0, 0x0E, 0x93, 0xF3, 0xAF, 0x97, 0xF5} }; // current beta testroot.cer (also used for OEM testsigning)
